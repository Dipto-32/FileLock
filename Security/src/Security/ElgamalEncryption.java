...
public class ElgamalEncryption extends JFrame {
	...
	private JPasswordField secretkey;
	 ...
	 BigInteger  alpha, b;
	 BigInteger p= new BigInteger("303199667111572785629200858327826657453");
	 String str;
	 String spath;
	/**
...
public void elgamal_decryption(BigInteger dec_key)
{
	...
	public ElgamalEncryption() {
		...
		btnChooseFile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
			 		...
			 		fc.setCurrentDirectory(new java.io.File("C:/Users/Dipto/Desktop"));
		...
		btnChooseFile.setBounds(293, 27, 89, 23);
		contentPane.add(btnChooseFile);
		
		JLabel lblEnterSecretKey = new JLabel("Enter secret key");
		lblEnterSecretKey.setFont(new Font("Times New Roman", Font.BOLD, 16));
		lblEnterSecretKey.setBounds(36, 59, 113, 36);
		contentPane.add(lblEnterSecretKey);
		
		secretkey = new JPasswordField();
		secretkey.setBounds(36, 93, 219, 20);
		...
		btnEncrypt.setBounds(34, 124, 89, 23);
		...
		btnDecrypt.setBounds(166, 124, 89, 23);
